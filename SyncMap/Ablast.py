# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_ForAblast.ipynb.

# %% auto 0
__all__ = ['VariableTracker', 'NodeSyncMap', 'data_preprocessing']

# %% ../nbs/03_ForAblast.ipynb 2
import copy
import math
import pprint
import re
...
class NodeSyncMap(object):
    def __init__(self, input_size, dimensions, adaptation_rate, 
                ...
                disable_repel_update = False, disable_attract_update = False
                ):
        ...
        #####################################
        ## for abalst experiment
        self.disable_repel_update = disable_repel_update
        self.disable_attract_update = disable_attract_update
        ####################################
    ...
    def compute_update(self, syncmap_previous, vplus, vminus):
        ...
        if self.disable_attract_update == False:
            ...
            total_plus_mask = plus_mask.bool()
            total_plus_weight = plus_mask.float()
        ...
        # ########### 2024-08-09 ############################
        if self.disable_repel_update == False:
